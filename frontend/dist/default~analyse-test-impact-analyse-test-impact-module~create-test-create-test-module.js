(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~analyse-test-impact-analyse-test-impact-module~create-test-create-test-module"],{
...
*/
(function (d) {
   true && module.exports ? (d["default"] = d, module.exports = d) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! highcharts */ "6n/F")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (r) {
    d(r);
    d.Highcharts = r;
    return d;
  ...
  r(d, "Extensions/Boost/BoostableMap.js", [d["Extensions/Boost/Boostables.js"]], function (d) {
    var x = {};
  ...
  r(d, "Extensions/Boost/WGLShader.js", [d["Core/Utilities.js"]], function (d) {
    ...
    return function (b) {
      ...
      function w(a, c) {
        var f = b.createShader("vertex" === c ? b.VERTEX_SHADER : b.FRAGMENT_SHADER);
        b.shaderSource(f, a);
        b.compileShader(f);
        return b.getShaderParameter(f, b.COMPILE_STATUS) ? f : (g.push("when compiling " + c + " shader:\n" + b.getShaderInfoLog(f)), !1);
      }
      ...
      function p() {
        ...
        var L = w("#version 100\n#define LN10 2.302585092994046\nprecision highp float;\nattribute vec4 aVertexPosition;\nattribute vec4 aColor;\nvarying highp vec2 position;\nvarying highp vec4 vColor;\nuniform mat4 uPMatrix;\nuniform float pSize;\nuniform float translatedThreshold;\nuniform bool hasThreshold;\nuniform bool skipTranslation;\nuniform float xAxisTrans;\nuniform float xAxisMin;\nuniform float xAxisMinPad;\nuniform float xAxisPointRange;\nuniform float xAxisLen;\nuniform bool  xAxisPostTranslate;\nuniform float xAxisOrdinalSlope;\nuniform float xAxisOrdinalOffset;\nuniform float xAxisPos;\nuniform bool  xAxisCVSCoord;\nuniform bool  xAxisIsLog;\nuniform bool  xAxisReversed;\nuniform float yAxisTrans;\nuniform float yAxisMin;\nuniform float yAxisMinPad;\nuniform float yAxisPointRange;\nuniform float yAxisLen;\nuniform bool  yAxisPostTranslate;\nuniform float yAxisOrdinalSlope;\nuniform float yAxisOrdinalOffset;\nuniform float yAxisPos;\nuniform bool  yAxisCVSCoord;\nuniform bool  yAxisIsLog;\nuniform bool  yAxisReversed;\nuniform bool  isBubble;\nuniform bool  bubbleSizeByArea;\nuniform float bubbleZMin;\nuniform float bubbleZMax;\nuniform float bubbleZThreshold;\nuniform float bubbleMinSize;\nuniform float bubbleMaxSize;\nuniform bool  bubbleSizeAbs;\nuniform bool  isInverted;\nfloat bubbleRadius(){\nfloat value = aVertexPosition.w;\nfloat zMax = bubbleZMax;\nfloat zMin = bubbleZMin;\nfloat radius = 0.0;\nfloat pos = 0.0;\nfloat zRange = zMax - zMin;\nif (bubbleSizeAbs){\nvalue = value - bubbleZThreshold;\nzMax = max(zMax - bubbleZThreshold, zMin - bubbleZThreshold);\nzMin = 0.0;\n}\nif (value < zMin){\nradius = bubbleZMin / 2.0 - 1.0;\n} else {\npos = zRange > 0.0 ? (value - zMin) / zRange : 0.5;\nif (bubbleSizeByArea && pos > 0.0){\npos = sqrt(pos);\n}\nradius = ceil(bubbleMinSize + pos * (bubbleMaxSize - bubbleMinSize)) / 2.0;\n}\nreturn radius * 2.0;\n}\nfloat translate(float val,\nfloat pointPlacement,\nfloat localA,\nfloat localMin,\nfloat minPixelPadding,\nfloat pointRange,\nfloat len,\nbool  cvsCoord,\nbool  isLog,\nbool  reversed\n){\nfloat sign = 1.0;\nfloat cvsOffset = 0.0;\nif (cvsCoord) {\nsign *= -1.0;\ncvsOffset = len;\n}\nif (isLog) {\nval = log(val) / LN10;\n}\nif (reversed) {\nsign *= -1.0;\ncvsOffset -= sign * len;\n}\nreturn sign * (val - localMin) * localA + cvsOffset + \n(sign * minPixelPadding);\n}\nfloat xToPixels(float value) {\nif (skipTranslation){\nreturn value;// + xAxisPos;\n}\nreturn translate(value, 0.0, xAxisTrans, xAxisMin, xAxisMinPad, xAxisPointRange, xAxisLen, xAxisCVSCoord, xAxisIsLog, xAxisReversed);// + xAxisPos;\n}\nfloat yToPixels(float value, float checkTreshold) {\nfloat v;\nif (skipTranslation){\nv = value;// + yAxisPos;\n} else {\nv = translate(value, 0.0, yAxisTrans, yAxisMin, yAxisMinPad, yAxisPointRange, yAxisLen, yAxisCVSCoord, yAxisIsLog, yAxisReversed);// + yAxisPos;\nif (v > yAxisLen) {\nv = yAxisLen;\n}\n}\nif (checkTreshold > 0.0 && hasThreshold) {\nv = min(v, translatedThreshold);\n}\nreturn v;\n}\nvoid main(void) {\nif (isBubble){\ngl_PointSize = bubbleRadius();\n} else {\ngl_PointSize = pSize;\n}\nvColor = aColor;\nif (skipTranslation && isInverted) {\ngl_Position = uPMatrix * vec4(aVertexPosition.y + yAxisPos, aVertexPosition.x + xAxisPos, 0.0, 1.0);\n} else if (isInverted) {\ngl_Position = uPMatrix * vec4(yToPixels(aVertexPosition.y, aVertexPosition.z) + yAxisPos, xToPixels(aVertexPosition.x) + xAxisPos, 0.0, 1.0);\n} else {\ngl_Position = uPMatrix * vec4(xToPixels(aVertexPosition.x) + xAxisPos, yToPixels(aVertexPosition.y, aVertexPosition.z) + yAxisPos, 0.0, 1.0);\n}\n}", "vertex"),
            f = w("precision highp float;\nuniform vec4 fillColor;\nvarying highp vec2 position;\nvarying highp vec4 vColor;\nuniform sampler2D uSampler;\nuniform bool isCircle;\nuniform bool hasColor;\nvoid main(void) {\nvec4 col = fillColor;\nvec4 tcol = texture2D(uSampler, gl_PointCoord.st);\nif (hasColor) {\ncol = vColor;\n}\nif (isCircle) {\ncol *= tcol;\nif (tcol.r < 0.0) {\ndiscard;\n} else {\ngl_FragColor = col;\n}\n} else {\ngl_FragColor = col;\n}\n}", "fragment");
        if (!L || !f) return h = !1, d(), !1;
        h = b.createProgram();
        b.attachShader(h, L);
        b.attachShader(h, f);
        b.linkProgram(h);
        if (!b.getProgramParameter(h, b.LINK_STATUS)) return g.push(b.getProgramInfoLog(h)), d(), h = !1;
        b.useProgram(h);
      ...
      function D(a, c) {
        b && h && (a = y[a] = y[a] || b.getUniformLocation(h, a), b.uniform1f(a, c));
      }
      ...
      return b && !p() ? !1 : {
        ...
        setBubbleUniforms: function setBubbleUniforms(a, g, f) {
          var u = a.options,
              e = Number.MAX_VALUE,
              d = -Number.MAX_VALUE;
          b && h && "bubble" === a.type && (e = l(u.zMin, x(g, !1 === u.displayNegative ? u.zThreshold : -Number.MAX_VALUE, e)), d = l(u.zMax, Math.max(d, f)), b.uniform1i(P, 1), b.uniform1i(c, 1), b.uniform1i(k, "width" !== a.options.sizeBy), b.uniform1i(t, a.options.sizeByAbsoluteValue), D("bubbleZMin", e), D("bubbleZMax", d), D("bubbleZThreshold", a.options.zThreshold), D("bubbleMinSize", a.minPxSize), D("bubbleMaxSize", a.maxPxSize));
        },
        bind: function bind() {
          b && h && b.useProgram(h);
        },
        ...
        create: p,
        setUniform: D,
        setPMatrix: function setPMatrix(a) {
          b && h && b.uniformMatrix4fv(e, !1, a);
        },
        setColor: function setColor(a) {
          b && h && b.uniform4f(m, a[0] / 255, a[1] / 255, a[2] / 255, a[3]);
        },
        setPointSize: function setPointSize(a) {
          b && h && b.uniform1f(n, a);
        },
        setSkipTranslation: function setSkipTranslation(a) {
          b && h && b.uniform1i(G, !0 === a ? 1 : 0);
        },
        setTexture: function setTexture(a) {
          b && h && b.uniform1i(K, a);
        },
        setDrawAsCircle: function setDrawAsCircle(a) {
          b && h && b.uniform1i(c, a ? 1 : 0);
        },
        reset: function reset() {
          b && h && (b.uniform1i(P, 0), b.uniform1i(c, 0));
        },
        setInverted: function setInverted(a) {
          b && h && b.uniform1i(u, a);
        },
  ...
  r(d, "Extensions/Boost/WGLVBuffer.js", [], function () {
    return function (d, C, q) {
      ...
      return {
        ...
        allocate: function allocate(d) {
          D = -1;
          p = new Float32Array(4 * d);
        },
        push: function push(d, e, b, m) {
          p && (p[++D] = d, p[++D] = e, p[++D] = b, p[++D] = m);
        }
      };
    };
  });
  r(d, "Extensions/Boost/WGLRenderer.js", [d["Core/Color/Color.js"], d["Extensions/Boost/WGLShader.js"], d["Extensions/Boost/WGLVBuffer.js"], d["Core/Globals.js"], d["Core/Utilities.js"]], function (d, C, q, l, b) {
    var x = d.parse,
        w = l.doc,
        p = b.isNumber,
        D = b.isObject,
    ...
    return function (b) {
      function m(a) {
        if (a.isSeriesBoosting) {
          ...
          "treemap" === a.type ? c *= 12 : "heatmap" === a.type ? c *= 6 : ia[a.type] && (c *= 2);
          return c;
        }
      ...
      function t(a, c) {
        function g(a) {
          a && (c.colorData.push(a[0]), c.colorData.push(a[1]), c.colorData.push(a[2]), c.colorData.push(a[3]));
        }

        function f(a, c, f, u, d) {
          g(d);
          z.usePreallocated ? L.push(a, c, f ? 1 : 0, u || 1) : (R.push(a), R.push(c), R.push(f ? 1 : 0), R.push(u || 1));
        }

        function u() {
          c.segments.length && (c.segments[c.segments.length - 1].to = R.length);
        }

        function e() {
          c.segments.length && c.segments[c.segments.length - 1].from === R.length || (u(), c.segments.push({
            from: R.length
          }));
        }
        ...
        function K(a, g) {
          z.useGPUTranslations || (c.skipTranslation = !0, a.x = G.toPixels(a.x, !0), a.y = P.toPixels(a.y, !0));
        ...
        if (!(E.boostData && 0 < E.boostData.length)) {
          E.gapSize && (Aa = "value" !== E.gapUnit ? E.gapSize * a.closestPointRange : E.gapSize);
          ma && (ma.some(function (a) {
            return "undefined" === typeof a.value ? (ha = new d(a.color), !0) : !1;
          }), ha || (ha = a.pointAttribs && a.pointAttribs().fill || a.color, ha = new d(ha)));
          n.inverted && (B = a.chart.plotHeight);
          a.closestPointRangePx = Number.MAX_VALUE;
          e();
          if (v && 0 < v.length) c.skipTranslation = !0, c.drawMode = "triangles", v[0].node && v[0].node.levelDynamic && v.sort(function (a, c) {
            if (a.node) {
            ...
            if ("undefined" !== typeof g && !isNaN(g) && null !== c.y) {
              g = c.shapeArgs;
              var f = n.styledMode ? c.series.colorAttribs(c) : f = c.series.pointAttribs(c);
              c = f["stroke-width"] || 0;
              A = x(f.fill).rgba;
              A[0] /= 255;
              A[1] /= 255;
              A[2] /= 255;
              "treemap" === a.type && (c = c || 1, Q = x(f.stroke).rgba, Q[0] /= 255, Q[1] /= 255, Q[2] /= 255, b(g.x, g.y, g.width, g.height, Q), c /= 2);
              "heatmap" === a.type && n.inverted && (g.x = G.len - g.x, g.y = P.len - g.y, g.width = -g.width, g.height = -g.height);
            ...
            for (; J < t.length - 1;) {
              ...
              if (Z) break;
              v = T && T[J];
              !w && D(v, !0) && v.color && (A = x(v.color).rgba, A[0] /= 255, A[1] /= 255, A[2] /= 255);
              ...
              } else v = H, F = y[J], t[J + 1] && (fa = t[J + 1]), t[J - 1] && (Y = t[J - 1]), q && q.length && (Ha = q[J], q[J] > c.zMax && (c.zMax = q[J]), q[J] < c.zMin && (c.zMin = q[J]));
              ...
              if (C || null !== v && null !== F) {
                ...
                null !== X && "undefined" !== typeof X && null !== l && "undefined" !== typeof l && (Ia = F >= X && F <= l);
                v > k && O.x < k && (O.x = v, O.y = F);
                v < p && I.x > p && (I.x = v, I.y = F);
                if (null !== F || !C) if (null !== F && (Ia || ya || V)) {
                  if ((fa >= p || v >= p) && (Y <= k || v <= k) && (za = !0), za || ya || V) {
                    Aa && v - Y > Aa && e();
                    ma && (A = ha.rgba, ma.some(function (a, c) {
                      c = ma[c - 1];
                    ...
                    if (!z.useGPUTranslations && (c.skipTranslation = !0, v = G.toPixels(v, !0), F = P.toPixels(F, !0), v > B && "points" === c.drawMode)) continue;

                    if (Ma) {
                      H = sa;
                      if (!1 === sa || "undefined" === typeof sa) H = 0 > F ? F : 0;
                      h || m || (H = Math.max(null === Ga ? X : Ga, X));
                      z.useGPUTranslations || (H = P.toPixels(H, !0));
                      f(v, H, 0, 0, A);
                    }

                    c.hasMarkers && za && !1 !== M && (a.closestPointRangePx = Math.min(a.closestPointRangePx, Math.abs(v - M)));
                    !z.useGPUTranslations && !z.usePreallocated && M && 1 > Math.abs(v - M) && r && 1 > Math.abs(F - r) ? z.debug.showSkipSummary && ++N : (E.step && !Ba && f(v, r, 0, 2, A), f(v, F, 0, "bubble" === a.type ? Ha || 1 : 2, A), M = v, r = F, Fa = !0, Ba = !1);
                  }
                } else e();
              } else e();
            }
            ...
            Fa || !1 === C || "line_strip" !== a.drawMode || (I.x < Number.MAX_VALUE && K(I, !0), O.x > -Number.MAX_VALUE && K(O));
          }
          u();
        }
      }
      ...
      function G(c) {
        a && (a.setUniform("xAxisTrans", c.transA), a.setUniform("xAxisMin", c.min), a.setUniform("xAxisMinPad", c.minPixelPadding), a.setUniform("xAxisPointRange", c.pointRange), a.setUniform("xAxisLen", c.len), a.setUniform("xAxisPos", c.pos), a.setUniform("xAxisCVSCoord", !c.horiz), a.setUniform("xAxisIsLog", !!c.logarithmic), a.setUniform("xAxisReversed", !!c.reversed));
      }

      function c(c) {
        a && (a.setUniform("yAxisTrans", c.transA), a.setUniform("yAxisMin", c.min), a.setUniform("yAxisMinPad", c.minPixelPadding), a.setUniform("yAxisPointRange", c.pointRange), a.setUniform("yAxisLen", c.len), a.setUniform("yAxisPos", c.pos), a.setUniform("yAxisCVSCoord", !c.horiz), a.setUniform("yAxisIsLog", !!c.logarithmic), a.setUniform("yAxisReversed", !!c.reversed));
      }
      ...
      function g(g) {
        if (g) M = g.chartWidth || 800, B = g.chartHeight || 400;else return !1;
        if (!(f && M && B && a)) return !1;
        ...
        a.bind();
        f.viewport(0, 0, M, B);
        a.setPMatrix([2 / M, 0, 0, 0, 0, -(2 / B), 0, 0, 0, 0, -2, 0, -1, 1, -1, 1]);
        ...
        I.forEach(function (b, K) {
          ...
          k = e(n.marker ? n.marker.enabled : null, b.series.xAxis.isRadial ? !0 : null, b.series.closestPointRangePx > 2 * ((n.marker ? n.marker.radius : 10) || 10));
          h = V[h && h.symbol || b.series.symbol] || V.circle;

          if (!(0 === b.segments.length || b.segmentslength && b.segments[0].from === b.segments[0].to)) {
            h.isReady && (f.bindTexture(f.TEXTURE_2D, h.handle), a.setTexture(h.handle));
            g.styledMode ? h = b.series.markerGroup && b.series.markerGroup.getStyle("fill") : (h = b.series.pointAttribs && b.series.pointAttribs().fill || b.series.color, n.colorByPoint && (h = b.series.chart.options.colors[K]));
            b.series.fillOpacity && n.fillOpacity && (h = new d(h).setOpacity(e(n.fillOpacity, 1)).get());
            h = x(h).rgba;
            z.useAlpha || (h[3] = 1);
            "lines" === b.drawMode && z.useAlpha && 1 > h[3] && (h[3] /= 10);
            "add" === n.boostBlending ? (f.blendFunc(f.SRC_ALPHA, f.ONE), f.blendEquation(f.FUNC_ADD)) : "mult" === n.boostBlending || "multiply" === n.boostBlending ? f.blendFunc(f.DST_COLOR, f.ZERO) : "darken" === n.boostBlending ? (f.blendFunc(f.ONE, f.ONE), f.blendEquation(f.FUNC_MIN)) : f.blendFuncSeparate(f.SRC_ALPHA, f.ONE_MINUS_SRC_ALPHA, f.ONE, f.ONE_MINUS_SRC_ALPHA);
            a.reset();
            0 < b.colorData.length && (a.setUniform("hasColor", 1), K = q(f, a), K.build(b.colorData, "aColor", 4), K.bind());
            a.setColor(h);
            G(b.series.xAxis);
            c(b.series.yAxis);
            u(E, t);
            "points" === b.drawMode && (n.marker && p(n.marker.radius) ? a.setPointSize(2 * n.marker.radius) : a.setPointSize(1));
            a.setSkipTranslation(b.skipTranslation);
            "bubble" === b.series.type && a.setBubbleUniforms(b.series, b.zMin, b.zMax);
            a.setDrawAsCircle(Z[b.series.type] || !1);
            if (0 < m || "line_strip" !== b.drawMode) for (m = 0; m < b.segments.length; m++) {
              L.render(b.segments[m].from, b.segments[m].to, b.drawMode);
            }
            if (b.hasMarkers && k) for (n.marker && p(n.marker.radius) ? a.setPointSize(2 * n.marker.radius) : a.setPointSize(10), a.setDrawAsCircle(!0), m = 0; m < b.segments.length; m++) {
      ...
      return r = {
        allocateBufferForSingleSeries: function allocateBufferForSingleSeries(a) {
          var c = 0;
          z.usePreallocated && (a.isSeriesBoosting && (c = m(a)), L.allocate(c));
        },
        pushSeries: function pushSeries(a) {
          0 < I.length && I[I.length - 1].hasMarkers && (I[I.length - 1].markerTo = Q.length);
        ...
        setSize: function setSize(c, g) {
          M === c && B === g || !a || (M = c, B = g, a.bind(), a.setPMatrix([2 / M, 0, 0, 0, 0, -(2 / B), 0, 0, 0, 0, -2, 0, -1, 1, -1, 1]));
        },
        inited: function inited() {
          return O;
        },
        setThreshold: u,
        init: function init(c, g) {
          function b(a, c) {
            var g = {
              isReady: !1,
            ...
            try {
              f.activeTexture(f.TEXTURE0), f.bindTexture(f.TEXTURE_2D, g.handle), f.texImage2D(f.TEXTURE_2D, 0, f.RGBA, f.RGBA, f.UNSIGNED_BYTE, g.texture), f.texParameteri(f.TEXTURE_2D, f.TEXTURE_WRAP_S, f.CLAMP_TO_EDGE), f.texParameteri(f.TEXTURE_2D, f.TEXTURE_WRAP_T, f.CLAMP_TO_EDGE), f.texParameteri(f.TEXTURE_2D, f.TEXTURE_MAG_FILTER, f.LINEAR), f.texParameteri(f.TEXTURE_2D, f.TEXTURE_MIN_FILTER, f.LINEAR), f.bindTexture(f.TEXTURE_2D, null), g.isReady = !0;
            } catch (U) {}
          }
          ...
          for (z.debug.timeSetup && console.time("gl setup"); u < d.length && !(f = c.getContext(d[u], {})); u++) {
            ;
          }

          if (f) g || k();else return !1;
          f.enable(f.BLEND);
        ...
        destroy: function destroy() {
          ...
          }), f.canvas.width = 1, f.canvas.height = 1);
        },
  ...
  r(d, "Extensions/Boost/BoostAttach.js", [d["Core/Chart/Chart.js"], d["Extensions/Boost/WGLRenderer.js"], d["Core/Globals.js"], d["Core/Utilities.js"]], function (d, C, q, l) {
    var b = q.doc,
        x = l.error,
    ...
    return function (p, l) {
      var q = p.chartWidth,
          ...
          m = b.implementation.hasFeature("www.http://w3.org/TR/SVG11/feature#Extensibility", "1.1");
      e = p.isChartSeriesBoosting() ? p : l;
      m = !1;
      e.renderTarget || (e.canvas = w, p.renderer.forExport || !m ? (e.renderTarget = p.renderer.image("", 0, 0, q, h).addClass("highcharts-boost-canvas").add(n), e.boostClear = function () {
        e.renderTarget.attr({
          href: ""
        });
      ...
      }) : (e.renderTargetFo = p.renderer.createElement("foreignObject").add(n), e.renderTarget = b.createElement("canvas"), e.renderTargetCtx = e.renderTarget.getContext("2d"), e.renderTargetFo.element.appendChild(e.renderTarget), e.boostClear = function () {
      ...
      }, e.boostClipRect = p.renderer.clipRect(), (e.renderTargetFo || e.renderTarget).clip(e.boostClipRect), e instanceof d && (e.markerGroup = e.renderer.g().add(n), e.markerGroup.translate(l.xAxis.pos, l.yAxis.pos)));
      e.canvas.width = q;
      e.canvas.height = h;
      e.boostClipRect.attr(p.getBoostClipRect(e));
      e.boostResizeTarget();
      e.boostClear();
      e.ogl || (e.ogl = C(function () {
      ...
      }), e.ogl.init(e.canvas) || x("[highcharts boost] - unable to init WebGL renderer"), e.ogl.setOptions(p.options.boost || {}), e instanceof d && e.ogl.allocateBuffer(p));
      e.ogl.setSize(q, h);
      return e.ogl;
    };
  });
  r(d, "Extensions/Boost/BoostUtils.js", [d["Core/Globals.js"], d["Extensions/Boost/BoostableMap.js"], d["Extensions/Boost/BoostAttach.js"], d["Core/Utilities.js"]], function (d, C, q, l) {
    function b() {
    ...
    function x(b, d, e) {
      b && d.renderTarget && d.canvas && !(e || d.chart).isChartSeriesBoosting() && b.render(e || d.chart);
    }
    ...
    function p(b, d, e, h, k, l) {
      ...
      u && (k < b.length ? l ? p(b, d, e, h, k, l) : y.requestAnimationFrame ? y.requestAnimationFrame(function () {
        p(b, d, e, h, k);
      }) : setTimeout(function () {
        p(b, d, e, h, k);
      }) : e && e());
    ...
    function r() {
      var b = 0,
          ...
          p = !1;
      if ("undefined" !== typeof y.WebGLRenderingContext) for (d = h.createElement("canvas"); b < e.length; b++) {
        try {
          if (p = d.getContext(e[b]), "undefined" !== typeof p && null !== p) return !0;
        } catch (k) {}
      }
      return !1;
    }
    ...
    l = {
      patientMax: b,
      boostEnabled: function boostEnabled(b) {
        return e(b && b.options && b.options.boost && b.options.boost.enabled, !0);
      },
      shouldForceChartSeriesBoosting: function shouldForceChartSeriesBoosting(d) {
        var h = 0,
            p = 0,
            n = e(d.options.boost && d.options.boost.allowForce, !0);
        if ("undefined" !== typeof d.boostForceChartBoost) return d.boostForceChartBoost;
        if (1 < d.series.length) for (var k = 0; k < d.series.length; k++) {
          var l = d.series[k];
          0 !== l.options.boostThreshold && !1 !== l.visible && "heatmap" !== l.type && (C[l.type] && ++p, b(l.processedXData, l.options.data, l.points) >= (l.options.boostThreshold || Number.MAX_VALUE) && ++h);
        }
        d.boostForceChartBoost = n && (p === d.series.length && 0 < h || 5 < h);
      ...
      eachAsync: p,
      hasWebGLSupport: r,
      pointDrawHandler: function pointDrawHandler(b) {
        var d = !0;
  ...
  r(d, "Extensions/Boost/BoostInit.js", [d["Core/Chart/Chart.js"], d["Core/Globals.js"], d["Core/Utilities.js"], d["Extensions/Boost/BoostUtils.js"], d["Extensions/Boost/BoostAttach.js"]], function (d, r, q, l, b) {
    var x = q.addEvent,
        w = q.extend,
        p = q.fireEvent,
        C = q.wrap,
    ...
    return function () {
        ...
        renderCanvas: function renderCanvas() {
          function c(a, c) {
            ...
            if (!g) {
              ...
              aa ? (ka && (e = a.slice(1, 3)), b = e[0], e = e[1]) : ja && (u = a.x, e = a.stackY, b = e - a.y);
              ta || (d = e >= C && e <= y);
              if (null !== e && u >= r && u <= w && d) if (a = f.toPixels(u, !0), z) {
                if ("undefined" === typeof U || a === D) {
                  aa || (b = e);
                  if ("undefined" === typeof da || e > ca) ca = e, da = c;
                  if ("undefined" === typeof U || b < S) S = b, U = c;
                }

                a !== D && ("undefined" !== typeof U && (e = l.toPixels(ca, !0), T = l.toPixels(S, !0), ea(a, e, da), T !== e && ea(a, T, U)), U = da = void 0, D = a);
          ...
          var C = a.min,
              ...
              la = this.xData || this.options.xData || this.processedXData || !1,
              ea = function ea(a, c, b) {
            a = Math.ceil(a);
            G = pa ? a : a + "," + c;
            E && !B[G] && (B[G] = !0, k.inverted && (a = f.len - a, c = l.len - c), ra.push({
              x: la ? la[na + b] : !1,
              clientX: a,
              plotX: a,
              plotY: c,
          ...
          if (this.visible) {
            ...
            k.isChartSeriesBoosting() ? (this.markerGroup && this.markerGroup !== k.markerGroup && this.markerGroup.destroy(), this.markerGroup = k.markerGroup, this.renderTarget && (this.renderTarget = this.renderTarget.destroy())) : (this.markerGroup === k.markerGroup && (this.markerGroup = void 0), this.markerGroup = g.plotGroup("markerGroup", "markers", !0, 1, k.seriesGroup));
            var ra = this.points = [];
            g.buildKDTree = e;
            a && (P(a, this), a.pushSeries(g), t(a, this, k));
            k.renderer.forExport || (qa.debug.timeKDTree && console.time("kd tree building"), n(ja ? g.data : m || x, c, d));
          }
        }
      });
      ...
      h.bubble && (delete h.bubble.prototype.buildKDTree, C(h.bubble.prototype, "markerAttribs", function (c) {
  ...
  r(d, "Extensions/BoostCanvas.js", [d["Core/Chart/Chart.js"], d["Core/Color/Color.js"], d["Core/Globals.js"], d["Series/LineSeries.js"], d["Core/Series/Series.js"], d["Core/Utilities.js"]], function (d, r, q, l, b, B) {
    var x = r.parse,
        p = q.doc,
        C = q.noop,
        y = B.addEvent,
        ...
        G;
    return function () {
      q.seriesTypes.heatmap && t(q.seriesTypes.heatmap.prototype, "drawPoints", function () {
        var c = this.chart,
            b = this.getContext(),
        ...
        b ? (this.points.forEach(function (e) {
          var f = e.plotY;
          "undefined" === typeof f || isNaN(f) || null === e.y || (f = e.shapeArgs, e = c.styledMode ? e.series.colorAttribs(e) : e.series.pointAttribs(e), b.fillStyle = e.fill, g ? b.fillRect(a.len - f.y + d.left, d.len - f.x + a.top, -f.height, -f.width) : b.fillRect(f.x + d.left, f.y + a.top, f.width, f.height));
      ...
      h(l.prototype, {
        getContext: function getContext() {
          var c = this.chart,
              ...
              a = this,
              e = function e(a, c, b, g, d, _e, f) {
            a.call(this, b, c, g, d, _e, f);
          };

          c.isChartSeriesBoosting() && (a = c, d = c.seriesGroup);
          var f = a.ctx;
          a.canvas || (a.canvas = p.createElement("canvas"), a.renderTarget = c.renderer.image("", 0, 0, b, g).addClass("highcharts-boost-canvas").add(d), a.ctx = f = a.canvas.getContext("2d"), c.inverted && ["moveTo", "lineTo", "rect", "arc"].forEach(function (a) {
            t(f, a, e);
            ...
            a === this && a.renderTarget.attr({
              href: ""
            });
          }, a.boostClipRect = c.renderer.clipRect(), a.renderTarget.clip(a.boostClipRect));
        ...
        cvsLineTo: function cvsLineTo(c, b, g) {
          c.lineTo(b, g);
        },
        renderCanvas: function renderCanvas() {
          var c = this,
          ...
          var qa = c.requireSorting,
              ...
              wa,
              W = la ? c.data : l || w,
              Ja = c.fillOpacity ? new r(c.color).setOpacity(P(b.fillOpacity, .75)).get() : c.color,
              v = function v() {
            da ? (N.fillStyle = Ja, N.fill()) : (N.strokeStyle = c.color, N.lineWidth = b.lineWidth, N.stroke());
          },
              Da = function Da(a, b, d, e) {
            0 === f && (N.beginPath(), aa && (N.lineJoin = "round"));
            g.scroller && "highcharts-navigator-series" === c.options.className ? (b += g.scroller.top, d && (d += g.scroller.top)) : b += g.plotTop;
            a += g.plotLeft;
            ra ? N.moveTo(a, b) : T ? T(N, a, b, d, ka) : aa ? aa(N, a, b) : ja && ja.call(c, N, a, b, E, e);
            f += 1;
            f === na && (v(), f = 0);
            ka = {
              clientX: a,
              ...
              Ea = this.xData || this.options.xData || this.processedXData || !1,
              xa = function xa(c, b, e) {
            wa = Ka ? c : c + "," + b;
            ta && !ia[wa] && (ia[wa] = !0, g.inverted && (c = d.len - c, b = a.len - b), La.push({
              x: Ea ? Ea[ea + e] : !1,
              clientX: c,
              plotX: c,
              plotY: b,
          ...
          (this.points || this.graph) && this.destroyGraphics();
          c.plotGroup("group", "series", c.visible ? "visible" : "hidden", b.zIndex, g.seriesGroup);
          ...
          this.visible && (99999 < w.length && (g.options.loading = m(t, {
            labelStyle: {
              backgroundColor: x("#ffffff").setOpacity(.75).get(),
              padding: "1em",
              borderRadius: "0.5em"
            },
            style: {
          ...
          }), B.clearTimeout(G), g.showLoading("Drawing..."), g.options.loading = t), k && console.time("canvas rendering"), q.eachAsync(W, function (b, e) {
            var f = !1,
                u = !1,
                h = !1,
                k = !1,
            ...
            if (!l) {
              if (Ca) {
                ...
                W[e + 1] && (h = W[e + 1][0]);
                W[e - 1] && (k = W[e - 1][0]);
              } else n = b, m = p[e], W[e + 1] && (h = W[e + 1]), W[e - 1] && (k = W[e - 1]);
              ...
              b = null === m;
              qa || (K = m >= I && m <= V);
              if (!b && (n >= D && n <= O && K || f || u)) if (n = Math.round(d.toPixels(n, !0)), z) {
                if ("undefined" === typeof ba || n === Z) {
                  pa || (q = m);
                  if ("undefined" === typeof oa || m > va) va = m, oa = e;
                  if ("undefined" === typeof ba || q < ua) ua = q, ba = e;
                }

                n !== Z && ("undefined" !== typeof ba && (m = a.toPixels(va, !0), S = a.toPixels(ua, !0), Da(n, ca ? Math.min(m, U) : m, ca ? Math.max(S, U) : S, e), xa(n, m, oa), S !== m && xa(n, S, ba)), ba = oa = void 0, Z = n);
              } else m = Math.round(a.toPixels(m, !0)), Da(n, m, S, e), xa(n, m, e);
              ra = b && !X;
              0 === e % 5E4 && (c.boostCopy || c.chart.boostCopy) && (c.boostCopy || c.chart.boostCopy)();
            }
            ...
            b && (h(a.style, {
              ...
              opacity: 0
            }), g.loadingShown = !1, G = setTimeout(function () {
      ...
      k.bubble && (k.bubble.prototype.cvsMarkerCircle = function (c, b, d, e, a) {
        c.moveTo(b, d);
        c.arc(b, d, this.radii && this.radii[a], 0, 2 * Math.PI, !1);
      }, k.bubble.prototype.cvsStrokeBatch = 1);
      h(k.area.prototype, {
        cvsDrawPoint: function cvsDrawPoint(c, b, d, e, a) {
          a && b !== a.clientX && (c.moveTo(a.clientX, a.yBottom), c.lineTo(a.clientX, a.plotY), c.lineTo(b, d), c.lineTo(b, e));
        },
        fill: !0,
        fillOpacity: !0,
        sampling: !0
      ...
      h(k.column.prototype, {
        cvsDrawPoint: function cvsDrawPoint(c, b, d, e) {
          c.rect(b - 1, d, 1, e - d);
        },
        fill: !0,
        sampling: !0
      ...
      d.prototype.callbacks.push(function (b) {
        y(b, "predraw", function () {
          b.renderTarget && b.renderTarget.attr({
            href: ""
          });
          b.canvas && b.canvas.getContext("2d").clearRect(0, 0, b.canvas.width, b.canvas.height);
        });
        y(b, "render", function () {
  ...
  r(d, "Extensions/Boost/BoostOverrides.js", [d["Core/Chart/Chart.js"], d["Core/Globals.js"], d["Core/Series/Point.js"], d["Core/Utilities.js"], d["Extensions/Boost/BoostUtils.js"], d["Extensions/Boost/Boostables.js"], d["Extensions/Boost/BoostableMap.js"]], function (d, r, q, l, b, B, w) {
    var p = l.addEvent,
        x = l.error,
        y = l.getOptions,
        h = l.isArray,
    ...
    d.prototype.isChartSeriesBoosting = function () {
      return n(this.options.boost && this.options.boost.seriesThreshold, 50) <= this.series.length || t(this);
    };
    ...
    k.prototype.getPoint = function (b) {
      ...
      !b || b instanceof this.pointClass || (c = new this.pointClass().init(this, this.options.data[b.i], d ? d[b.i] : void 0), c.category = n(this.xAxis.categories ? this.xAxis.categories[c.x] : c.x, c.x), c.dist = b.dist, c.distX = b.distX, c.plotX = b.plotX, c.plotY = b.plotY, c.index = b.i, c.isInside = this.isPointInside(b));
      return c;
    };
    ...
    m(q.prototype, "haloPath", function (b) {
      var c = this.series,
          ...
          a = this.plotY,
          e = c.chart.inverted;
      c.isSeriesBoosting && e && (this.plotX = c.yAxis.len - a, this.plotY = c.xAxis.len - d);
    ...
    m(k.prototype, "markerAttribs", function (b, c) {
      ...
      this.isSeriesBoosting && e && (c.plotX = this.yAxis.len - a, c.plotY = this.xAxis.len - d);
      var f = b.apply(this, Array.prototype.slice.call(arguments, 1));
    ...
    ["translate", "generatePoints", "drawTracker", "drawPoints", "render"].forEach(function (b) {
      function c(c) {
        var a = this.options.stacking && ("translate" === b || "generatePoints" === b);
        if (!this.isSeriesBoosting || a || !C(this.chart) || "heatmap" === this.type || "treemap" === this.type || !w[this.type] || 0 === this.options.boostThreshold) c.call(this);else if (this[b + "Canvas"]) this[b + "Canvas"]();
      }

      m(k.prototype, b, c);
      "translate" === b && "column bar arearange columnrange heatmap treemap".split(" ").forEach(function (d) {
    ...
    m(k.prototype, "processData", function (b) {
      ...
      var d = this,
          a = this.options.data;
      C(this.chart) && w[this.type] ? (c(a) && "heatmap" !== this.type && "treemap" !== this.type && !this.options.stacking && this.hasExtremes && this.hasExtremes(!0) || (b.apply(this, Array.prototype.slice.call(arguments, 1)), a = this.processedXData), (this.isSeriesBoosting = c(a)) ? (a = this.getFirstValidPoint(this.options.data), e(a) || h(a) || x(12, !1, this.chart), this.enterBoost()) : this.exitBoost && this.exitBoost()) : b.apply(this, Array.prototype.slice.call(arguments, 1));
    });
    p(k, "hide", function () {
    ...
    k.prototype.hasExtremes = function (b) {
      ...
      return c.data.length > (c.boostThreshold || Number.MAX_VALUE) && e(a.min) && e(a.max) && (!b || e(d.min) && e(d.max)) && (!h || e(h.min) && e(h.max));
    };
    ...
    B.forEach(function (b) {
      c[b] && (c[b].boostThreshold = 5E3, c[b].boostData = [], G[b].prototype.fillOpacity = !0);
    });
  });
  r(d, "Extensions/Boost/NamedColors.js", [d["Core/Color/Color.js"]], function (d) {
    var r = {
      aliceblue: "#f0f8ff",
      antiquewhite: "#faebd7",
      aqua: "#00ffff",
  ...
  r(d, "Extensions/Boost/Boost.js", [d["Extensions/Boost/BoostUtils.js"], d["Extensions/Boost/BoostInit.js"], d["Extensions/BoostCanvas.js"], d["Core/Utilities.js"]], function (d, r, q, l) {
    l = l.error;
    d = d.hasWebGLSupport;
...
*/
(function (e) {
   true && module.exports ? (e["default"] = e, module.exports = e) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! highcharts */ "6n/F")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (q) {
    e(q);
    e.Highcharts = q;
    return e;
  }).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
  ...
  q(e, "Mixins/Navigation.js", [], function () {
    return {
      initUpdate: function initUpdate(e) {
        e.navigation || (e.navigation = {
          updates: [],
          update: function update(e, g) {
      ...
      addUpdate: function addUpdate(e, l) {
  ...
  q(e, "Extensions/Exporting.js", [e["Core/Chart/Chart.js"], e["Mixins/Navigation.js"], e["Core/Globals.js"], e["Core/Options.js"], e["Core/Renderer/SVG/SVGRenderer.js"], e["Core/Utilities.js"]], function (e, l, g, k, q, f) {
    ...
    z(e.prototype, {
      ...
      contextMenu: function contextMenu(a, b, c, d, e, g, k) {
        var h = this,
...
/* harmony import */ var _home_ubuntu_demodata_RTMFastTool_frontend_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/createClass */ "vuIU");
/* harmony import */ var _home_ubuntu_demodata_RTMFastTool_frontend_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/classCallCheck */ "1OyB");
...
function MultiSelectComponent_span_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate"](ctx_r0._placeholder);
  }
}
...
function MultiSelectComponent_span_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function MultiSelectComponent_span_8_Template_a_click_2_listener($event) {
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("hidden", k_r8 > ctx_r1._settings.itemsShowLimit - 1);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate1"]("\n        ", item_r7.text, "\n        ");
  }
}

function MultiSelectComponent_span_12_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate1"]("+", ctx_r2.itemShowRemaining(), "");
  }
}

function MultiSelectComponent_li_23_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function MultiSelectComponent_li_23_Template_li_click_0_listener() {
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("checked", ctx_r3.isAllItemsSelected())("disabled", ctx_r3.disabled || ctx_r3.isLimitSelectionReached());
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate"](!ctx_r3.isAllItemsSelected() ? ctx_r3._settings.selectAllText : ctx_r3._settings.unSelectAllText);
  }
}

function MultiSelectComponent_li_25_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("ngModelChange", function MultiSelectComponent_li_25_Template_input_ngModelChange_2_listener($event) {
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r14);
      var ctx_r13 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"]();
      return ctx_r13.filter.text = $event;
    })("ngModelChange", function MultiSelectComponent_li_25_Template_input_ngModelChange_2_listener($event) {
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r14);
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("readOnly", ctx_r4.disabled)("placeholder", ctx_r4._settings.searchPlaceholderText)("ngModel", ctx_r4.filter.text);
  }
}

function MultiSelectComponent_li_30_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function MultiSelectComponent_li_30_Template_li_click_0_listener($event) {
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("checked", ctx_r5.isSelected(item_r16))("disabled", ctx_r5.disabled || ctx_r5.isLimitSelectionReached() && !ctx_r5.isSelected(item_r16));
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate"](item_r16.text);
  }
}

function MultiSelectComponent_li_33_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate"](ctx_r6._settings.noDataAvailablePlaceholderText);
  }
}
...
function ListItem(source) {
  Object(_home_ubuntu_demodata_RTMFastTool_frontend_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_1__["default"])(this, ListItem);
...
var MultiSelectComponent = /*#__PURE__*/function () {
  ...
  function MultiSelectComponent(cdr) {
    Object(_home_ubuntu_demodata_RTMFastTool_frontend_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_1__["default"])(this, MultiSelectComponent);
    ...
    this.disabled = false;
    this.onFilterChange = new _angular_core__WEBPACK_IMPORTED_MODULE_2__["EventEmitter"]();
    this.onDropDownClose = new _angular_core__WEBPACK_IMPORTED_MODULE_2__["EventEmitter"]();
  ...
  Object(_home_ubuntu_demodata_RTMFastTool_frontend_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_0__["default"])(MultiSelectComponent, [{
    key: "placeholder",
    ...
    set: function set(value) {
      ...
      if (!value) {
        ...
        this._data = value.map(function (item) {
          return typeof item === 'string' ? new ListItem(item) : new ListItem({
    ...
    value: function onItemClick($event, item) {
      ...
      var
      /** @type {?} */
      found = this.isSelected(item);
      var
      /** @type {?} */
      allowAdd = this._settings.limitSelection === -1 || this._settings.limitSelection > 0 && this.selectedItems.length < this._settings.limitSelection;
        ...
        if (this._settings.singleSelection) {
          try {
            if (value.length >= 1) {
              ...
              /** @type {?} */
              firstItem = value[0];
              this.selectedItems = [typeof firstItem === 'string' ? new ListItem(firstItem) : new ListItem({
          ...
          /** @type {?} */
          e) {// console.error(e.body.msg);
          }
        } else {
          var
          /** @type {?} */
          _data = value.map(function (item) {
            return typeof item === 'string' ? new ListItem(item) : new ListItem({
...
MultiSelectComponent.ɵfac = function MultiSelectComponent_Factory(t) {
  return new (t || MultiSelectComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_2__["ChangeDetectorRef"]));
};

MultiSelectComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
  type: MultiSelectComponent,
  selectors: [["ng-multiselect-dropdown"]],
  hostBindings: function MultiSelectComponent_HostBindings(rf, ctx) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("blur", function MultiSelectComponent_blur_HostBindingHandler() {
  ...
  features: [_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵProvidersFeature"]([DROPDOWN_CONTROL_VALUE_ACCESSOR])],
  decls: 37,
  vars: 17,
  ...
  template: function MultiSelectComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("blur", function MultiSelectComponent_Template_div_blur_0_listener() {
        return ctx.onTouched();
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function MultiSelectComponent_Template_span_click_4_listener($event) {
        return ctx.toggleDropdown($event);
      });
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](5, "\n      ");
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](6, MultiSelectComponent_span_6_Template, 2, 1, "span", 2);
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](7, "\n      ");
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](8, MultiSelectComponent_span_8_Template, 5, 2, "span", 3);
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](9, "\n      ");
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](10, "span", 4);
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](11, "\n        ");
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](12, MultiSelectComponent_span_12_Template, 2, 1, "span", 5);
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](23, MultiSelectComponent_li_23_Template, 7, 3, "li", 9);
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](24, "\n      ");
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](25, MultiSelectComponent_li_25_Template, 4, 3, "li", 10);
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](26, "\n    ");
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](27, "\n    ");
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](28, "ul", 11);
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](29, "\n      ");
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](30, MultiSelectComponent_li_30_Template, 7, 3, "li", 12);
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵpipe"](31, "ng2ListFilter");
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](32, "\n      ");
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](33, MultiSelectComponent_li_33_Template, 5, 1, "li", 13);
    ...
    if (rf & 2) {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ctx.selectedItems.length == 0);
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](2);
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngForOf", ctx.selectedItems)("ngForTrackBy", ctx.trackByFn);
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](4);
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ctx.itemShowRemaining() > 0);
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](2);
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngClass", ctx._settings.defaultOpen ? "dropdown-up" : "dropdown-down");
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](5);
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("hidden", !ctx._settings.defaultOpen);
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](4);
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ctx._data.length > 0 && !ctx._settings.singleSelection && ctx._settings.enableCheckAll && ctx._settings.limitSelection === -1);
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](2);
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ctx._data.length > 0 && ctx._settings.allowSearchFilter);
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](3);
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵstyleProp"]("max-height", ctx._settings.maxHeight + "px");
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](2);
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngForOf", _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵpipeBind2"](31, 14, ctx._data, ctx.filter));
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](3);
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ctx._data.length == 0);
    }
  },
...
(function () {
  _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵsetClassMetadata"](MultiSelectComponent, [{
...
var ClickOutsideDirective = /*#__PURE__*/function () {
  ...
  function ClickOutsideDirective(_elementRef) {
    Object(_home_ubuntu_demodata_RTMFastTool_frontend_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_1__["default"])(this, ClickOutsideDirective);
  ...
  Object(_home_ubuntu_demodata_RTMFastTool_frontend_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_0__["default"])(ClickOutsideDirective, [{
    key: "onClick",
...
(function () {
  _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵsetClassMetadata"](ClickOutsideDirective, [{
...
var ListFilterPipe = /*#__PURE__*/function () {
  function ListFilterPipe() {
    Object(_home_ubuntu_demodata_RTMFastTool_frontend_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_1__["default"])(this, ListFilterPipe);
  }

  Object(_home_ubuntu_demodata_RTMFastTool_frontend_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_0__["default"])(ListFilterPipe, [{
    key: "transform",
    value:
    /**
     * @param {?} items
     ...
     * @return {?}
     */
    function transform(items, filter) {
      var _this5 = this;
...
(function () {
  _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵsetClassMetadata"](ListFilterPipe, [{
...
var NgMultiSelectDropDownModule = /*#__PURE__*/function () {
  function NgMultiSelectDropDownModule() {
    Object(_home_ubuntu_demodata_RTMFastTool_frontend_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_1__["default"])(this, NgMultiSelectDropDownModule);
  }

  Object(_home_ubuntu_demodata_RTMFastTool_frontend_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_0__["default"])(NgMultiSelectDropDownModule, null, [{
    key: "forRoot",
    value:
    /**
     * @return {?}
...
NgMultiSelectDropDownModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineNgModule"]({
  type: NgMultiSelectDropDownModule
});
NgMultiSelectDropDownModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjector"]({
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵsetNgModuleScope"](NgMultiSelectDropDownModule, {
...
(function () {
  _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵsetClassMetadata"](NgMultiSelectDropDownModule, [{
...
*/
(function (c) {
   true && module.exports ? (c["default"] = c, module.exports = c) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! highcharts */ "6n/F")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (A) {
    c(A);
    c.Highcharts = A;
    return c;
  }).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
...
*/
(function (a) {
   true && module.exports ? (a["default"] = a, module.exports = a) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! highcharts */ "6n/F")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (d) {
    a(d);
    a.Highcharts = d;
    return a;
  }).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
...
//# sourceMappingURL=default~analyse-test-impact-analyse-test-impact-module~create-test-create-test-module.js.map